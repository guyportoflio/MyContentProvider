...
public class StudentsProvider extends ContentProvider{
    ...
    /**
     * helper class that actually creates and manages the underlying data repository
     *
     */
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
       DatabaseHelper(Context context){
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
          db.execSQL("DROP TABLE IF EXISTS " + STUDENT_TABLE_NAME); //delete all
    ...
    public boolean onCreate() {
        ...
        /**
         * create a writeable database which will be trigeered if database doesnt exist
         */
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        /**
         * if a record is added successfully
         */
        if (rowID > 0) {
            ...
            try {
                throw new SQLException("Failed to add records into:" + uri);
